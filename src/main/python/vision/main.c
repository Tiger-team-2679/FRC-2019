...
static PyObject *__pyx_pf_4main_f(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x); /* proto */
static PyObject *__pyx_pf_4main_2integrate_f(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_N); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4main_1f(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyMethodDef __pyx_mdef_4main_1f = {"f", (PyCFunction)__pyx_pw_4main_1f, METH_O, 0};
static PyObject *__pyx_pw_4main_1f(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  double __pyx_v_x;
  PyObject *__pyx_r = 0;
  ...
  __pyx_r = __pyx_pf_4main_f(__pyx_self, ((double)__pyx_v_x));
...
static PyObject *__pyx_pf_4main_f(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_x) {
...
/* Python wrapper */
static PyObject *__pyx_pw_4main_3integrate_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4main_3integrate_f = {"integrate_f", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4main_3integrate_f, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4main_3integrate_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_a;
  double __pyx_v_b;
  int __pyx_v_N;
  PyObject *__pyx_r = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("main.integrate_f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4main_2integrate_f(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_N);
...
static PyObject *__pyx_pf_4main_2integrate_f(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_N) {
  int __pyx_v_i;
  double __pyx_v_s;
  double __pyx_v_dx;
  PyObject *__pyx_r = NULL;
 ...
 */
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_main_pyx, __pyx_n_s_f, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4main_1f, NULL, __pyx_n_s_main_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef double s, dx
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4main_3integrate_f, NULL, __pyx_n_s_main_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
